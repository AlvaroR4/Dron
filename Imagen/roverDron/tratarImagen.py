"""
Recibe imágenes de ROS, detecta contornos rojos filtrando por color y tamaño mínimo, y calcula centroide, 
  offset respecto al centro de la imagen y distancia estimada (basada en tamaño real y aparente) 
  para cada contorno válido
De todos los contornos válidos detectados en un frame, selecciona el que tiene 
  la menor distancia estimada como el objetivo "más cercano"
Envía por UDP el offset (x, y), la distancia estimada y 
  el número total de detecciones del objetivo más cercano (o ceros si no detectó ninguno) 
"""
import rclpy
...
class ImageProcessorSimple(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            Image,
            '/world/rover/model/x500_mono_cam_down_2/link/camera_link/sensor/imager/image',
